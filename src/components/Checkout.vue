      ...
      >
        <div class="flex flex-col justify-start items-start w-full space-y-9">
          <div class="flex justify-start flex-col items-start space-y-2">
            <button
              class="flex flex-row items-center text-gray-600 hover:text-gray-500 space-x-1"
            >
              <svg
                class="fill-stroke"
                width="14"
          ...
          >
            <div
              class="xl:w-3/5 flex flex-col sm:flex-row xl:flex-col justify-center items-center bg-gray-100 py-7 sm:py-0 xl:py-10 px-10 xl:w-full"
            >
              <div
                class="flex flex-col justify-start items-start w-full space-y-4"
              >
                <p class="text-xl md:text-2xl leading-normal text-gray-800">
                  Logitech K251
                </p>
            ...
            <div class="p-8 bg-gray-100 flex flex-col lg:w-full xl:w-3/5">
              ...
              <label class="mt-8 text-base leading-4 text-gray-800"
                >Card details</label
              >
              ...
              <div class="mt-2 flex-col">
                <div class="relative">
                  ...
                  <svg
                    ...
                    v-if="show"
                    id="openIcon"
                    class="cursor-pointer transform rotate-180 absolute top-4 right-4"
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                    fill="none"
                  ...
                  <div
                    id="dropdown"
                    v-if="show"
                    class="mt-1 absolute z-10 w-full flex bg-gray-50 justify-start flex-col text-gray-600"
                  >
                    <div
                      @click="(country = 'China'), (show = false)"
                      class="cursor-pointer hover:bg-gray-800 hover:text-white px-4 py-2"
                    >
                      China
                    </div>
                    <div
                      @click="(country = 'Russia'), (show = false)"
                      class="cursor-pointer hover:bg-gray-800 hover:text-white px-4 py-2"
                    >
                      Russia
                    </div>
                    <div
                      @click="(country = 'UK'), (show = false)"
                      class="cursor-pointer hover:bg-gray-800 hover:text-white px-4 py-2"
                    >
                      UK
                    </div>
